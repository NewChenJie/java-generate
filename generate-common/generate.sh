...
TARGET_ENTITY="com.sixi.${GROUP}.${SERVER}.domain.entity"
TARGET_MAPPER="com.sixi.${GROUP}.${SERVER}.mapper"
...
<generatorConfiguration>
    <context id="info" targetRuntime="MyBatis3">
        ...
        <!--启用Lombok插件-->
        <plugin type="com.cj.mybatis.generator.plugins.LombokPlugin"/>
        <!--启用注释插件-->
        <commentGenerator type="com.cj.mybatis.generator.plugins.MyCommentGenerator">
                    <!-- 去除自动生成的注释 -->
